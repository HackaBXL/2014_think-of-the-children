...
(function($) {
    ...
    function TagsInput(element, options) {
        ...
        this.$input = $('<input class="test" type="text" placeholder="' + this.placeholderText + '"/>').appendTo(this.$container);
    ...
    TagsInput.prototype = {
        ...
        add: function(item, dontPushVal) {
            ...
            if ((existing && !self.options.allowDuplicates) || !test) {
                // Invoke onTagExists
            ...
            if (this.Pb === b || a < this.Pb || this.Xa <= a) {
                ...
                for (;;) {
                    ...
                    if (q.ya <= a) e = Math.max(e, q.ya), q.Oa && (q.Oa = l);
                        ...
                        q.ya), e = Math.max(e, q.startTime), q.Oa = f; if (g)
                        if (0 === w) break;
                        else w--;
